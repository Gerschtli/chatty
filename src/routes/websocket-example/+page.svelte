<script lang="ts">
	...
	let pendingRequests: Map<string, { resolve: (value: any) => void; reject: (reason: any) => void; timeout: number }> = new Map();
...
<div>
	<input bind:value={inputMessage} placeholder="Type a message" on:keydown={(e) => e.key === 'Enter' && sendMessage()} />
